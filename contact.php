          ...
          <div class="col-lg-12">
            <form id="contactForm" name="sentMessage" novalidate>
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <textarea class="form-control" id="message" placeholder="Your Message *" required data-validation-required-message="Please enter a message." style="margin-top: 0px; margin-bottom: 0px; height: 246px;"></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
