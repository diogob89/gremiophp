...
<?php include 'nav.php'; ?>
	...
	<img src="news18.jpg" style="width:250px; height:700px; padding-bottom:50px; padding-top:50px">
	<img src="news19.jpg" style="width:630px; height:550px; padding-bottom:100px; padding-left:50px">
	
			
	<a href="news5.php"><button type="button" name="" value="" class="css3button" style="float:left;"><< Previous </button></a>
